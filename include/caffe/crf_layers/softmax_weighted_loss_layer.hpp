...
namespace caffe {
     ...
     *   -# @f$ (N \times 1 \times 1 \times 1) @f$
     *      the weights @f$ l @f$, a Blob with values
     *      @f$ l_n \in [0, 1, 2, ..., K - 1] @f$
     *      indicating the weight of corresponding pixels
    ...
    public:
         ...
         */
        // bottom[0] the input for softmax
        // bottom[1] the label of each pixel
        // bottom[2] the weight of each pixel
