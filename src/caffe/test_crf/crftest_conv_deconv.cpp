...
namespace caffe {
    ...
    class ConvolutionDeconvolutionLayerTest : public MultiDeviceTest<TypeParam> {
        typedef typename TypeParam::Dtype Dtype;
        
    public:
        ConvolutionDeconvolutionLayerTest()
        : blob_bottom_(new Blob<Dtype>(1, 1, 10, 10)),
        ...
        virtual ~ConvolutionDeconvolutionLayerTest() {
            delete blob_bottom_;
            delete blob_top_;
        }
    ...
    TYPED_TEST_CASE(ConvolutionDeconvolutionLayerTest, TestDtypesAndDevices);
    
    TYPED_TEST(ConvolutionDeconvolutionLayerTest, TestSetup) {
        typedef typename TypeParam::Dtype Dtype;
    ...
    TYPED_TEST(ConvolutionDeconvolutionLayerTest, ConvolutionDeconvolutionLayerForward) {
        typedef typename TypeParam::Dtype Dtype;
        LayerParameter layer_param;
        ConvolutionParameter* conv_param = layer_param.mutable_convolution_param();
        conv_param->set_kernel_size(3,3);
...
//        print_blob(this->GetRefBlobTop(), false);
...
//    TYPED_TEST(ConvolutionDeconvolutionLayerTest, ConvolutionDeconvolutionLayerBackward) {
//        typedef typename TypeParam::Dtype Dtype;
//        LayerParameter layer_param;
